...
class DualMGNV(nn.Module):
    def __init__(self,num_classes):
        super(DualMGNV, self).__init__()
        ...
        self.hp2 = nn.Sequential(copy.deepcopy(res_conv4), copy.deepcopy(res_p_conv5))
        self.hp3 = nn.Sequential(copy.deepcopy(res_conv4), copy.deepcopy(res_p_conv5))
    ...
    def forward(self, x, for_eval =False):
        ...
        # horizontal scores
       # lh_p1 = self.fc_hid_2048_0(fhg_p2)  # [batch_size, num_classes]
        lh_p2 = self.fc_hid_2048_1(fhg_p2)  # [batch_size, num_classes]
        lh_p3 = self.fc_hid_2048_2(fhg_p3)  # [batch_size, num_classes]
        ...
        return predict, fg_p1, fg_p2, fg_p3,fhg_p2, fhg_p3,l_p1, l_p2, l_p3, l0_p2, l1_p2, l0_p3, l1_p3, l2_p3,lh_p2,lh_p3,lh0_p2, lh1_p2, lh0_p3, lh1_p3, lh2_p3
