...
class DualMGN(nn.Module):
    def __init__(self,num_classes, num_split =0, cluster=0):
        ...
        self.fc_hid_2048_0 = nn.Linear(feats, num_classes)
        self.fc_hid_2048_1 = nn.Linear(feats, num_classes)
        self.fc_hid_2048_2 = nn.Linear(feats, num_classes)
    ...
    def forward(self, x, for_eval =False):
        ...
        fg_p1 = self.reduction(zg_p1).squeeze(dim=3).squeeze(dim=2) #[batch_size, 256]
        fg_p2 = self.reduction(zg_p2).squeeze(dim=3).squeeze(dim=2) #[batch_size, 256]
        fg_p3 = self.reduction(zg_p3).squeeze(dim=3).squeeze(dim=2) #[batch_size, 256]
        ...
        fhg_p2 = self.reduction_h(hg_p2).squeeze(dim=3).squeeze(dim=2)
        fhg_p3 = self.reduction_h(hg_p3).squeeze(dim=3).squeeze(dim=2)
        ...
        lh0_p2 = self.fc_hid_256_1_0(f0_p2)  # [batch_size, num_classes]
        lh1_p2 = self.fc_hid_256_1_1(f1_p2)  # [batch_size, num_classes]
        lh0_p3 = self.fc_hid_256_2_0(f0_p3)  # [batch_size, num_classes]
        lh1_p3 = self.fc_hid_256_2_1(f1_p3)  # [batch_size, num_classes]
        lh2_p3 = self.fc_hid_256_2_2(f2_p3)  # [batch_size, num_classes]



        predict = torch.cat([fg_p1, fg_p2, fg_p3, f0_p2, f1_p2, f0_p3, f1_p3, f2_p3,fhg_p2,fhg_p3,fh0_p2,fh1_p2,fh0_p3,fh1_p3,fh2_p3], dim=1)

        return predict, fg_p1, fg_p2, fg_p3,fhg_p2,fhg_p3,l_p1, l_p2, l_p3, l0_p2, l1_p2, l0_p3, l1_p3, l2_p3,lh_p1, lh_p2, lh_p3, lh0_p2, lh1_p2, lh0_p3, lh1_p3, lh2_p3
