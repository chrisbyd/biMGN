...
class VehicleID(BaseImageDataset):
    ...
    def __init__(self, root='datasets', verbose=True, test_size=800, **kwargs):
        ...
        elif self.test_size == 3200:
            self.test_list = osp.join(self.split_dir, 'test_list_3200.txt')
    ...
    def check_before_run(self):
        ...
        if self.test_size not in [800, 1600, 2400,3200]:
    ...
    def parse_img_pids(self, nl_pairs, pid2label=None):
        # nl_pair is the pairs of img name and label
        output = []
